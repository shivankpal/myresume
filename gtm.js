...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return-1\u003C",["escape",["macro",0],8,16],".indexOf(\"[object Object]\")?!1:!0})();"]
    },{
      "function":"__jsm",
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_load":true,
      "vtp_html":"\u003Cscript type=\"text\/javascript\"\u003E(function(b,c,e,f,d){b[d]=b[d]||[];var g=function(){var a={ti:\"4023854\"};a.q=b[d];b[d]=new UET(a);b[d].push(\"pageLoad\")};var a=c.createElement(e);a.src=f;a.async=1;a.onload=a.onreadystatechange=function(){var b=this.readyState;b\u0026\u0026\"loaded\"!==b\u0026\u0026\"complete\"!==b||(g(),a.onload=a.onreadystatechange=null)};c=c.getElementsByTagName(e)[0];c.parentNode.insertBefore(a,c)})(window,document,\"script\",\"\/\/bat.bing.com\/bat.js\",\"uetq\");\u003C\/script\u003E\n\u003Cnoscript\u003E\n\u003Cimg src=\"\/\/bat.bing.com\/action\/0?ti=4023854\u0026amp;Ver=2\" height=\"0\" width=\"0\" style=\"display:none; visibility: hidden;\"\u003E\n\u003C\/noscript\u003E",
      ...
      "priority":1,
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/javascript\"\u003Efunction getParameterByName(a){a=a.replace(\/[\\[]\/,\"\\\\[\").replace(\/[\\]]\/,\"\\\\]\");a=new RegExp(\"[\\\\?\\x26]\"+a+\"\\x3d([^\\x26#]*)\");a=a.exec(location.search);return null===a?\"\":decodeURIComponent(a[1].replace(\/\\+\/g,\" \"))}function getCookiegtm(a){a+=\"\\x3d\";for(var c=document.cookie.split(\";\"),b=0;b\u003Cc.length;b++){for(var d=c[b];\" \"==d.charAt(0);)d=d.substring(1);if(0==d.indexOf(a))return d.substring(a.length,d.length)}return\"\"}\nfunction setCookiegtm(a,c){document.cookie=a+\"\\x3d\"+c+\";path\\x3d\/;domain\\x3d.myperfectresume.com\"}function getCookieItem(a){var c=getCookiegtm(\"gtmvalues\"),b=[],d=\"\";null!=c\u0026\u0026void 0!=c\u0026\u0026\"\"!=c\u0026\u0026(b=JSON.parse(c),$.each(b,function(b,c){c.n===a\u0026\u0026(d=c.v)}));return d}function addCookieItem(a,c){var b=getCookiegtm(\"gtmvalues\"),d=[];null!=b\u0026\u0026void 0!=b\u0026\u0026\"\"!=b\u0026\u0026(d=JSON.parse(b));b={n:a,v:c};\"\"==getCookieItem(a)?d.push(b):$.map(d,function(b,d){b.n==a\u0026\u0026(b.v=c)});setCookiegtm(\"gtmvalues\",JSON.stringify(d))}\nvar mode=getParameterByName(\"mode\"),iorderid=getParameterByName(\"orderid\"),icust=getParameterByName(\"customerid\"),bingmpr=getCookieItem(\"bmpr\"),icustorder=icust+iorderid;mode=mode.toLowerCase();\"update\"==mode||\"alreadysubscribeduser\"==mode||\"\"!=bingmpr\u0026\u0026bingmpr==icustorder||!(0\u003C=icust||0\u003C=iorderid)||(window.uetq=window.uetq||[],window.uetq.push({ea:\"Subscription\"}),addCookieItem(\"bmpr\",icustorder));\u003C\/script\u003E",
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "vtp_conversionId":"969244743",
      "vtp_conversionLabel":"D9fiCMmvwgcQx4CWzgM",
      "vtp_url":["macro",8],
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/javascript\"\u003Efunction getParameterByName(a){a=a.replace(\/[\\[]\/,\"\\\\[\").replace(\/[\\]]\/,\"\\\\]\");a=new RegExp(\"[\\\\?\\x26]\"+a+\"\\x3d([^\\x26#]*)\");a=a.exec(location.search);return null===a?\"\":decodeURIComponent(a[1].replace(\/\\+\/g,\" \"))}function getCookiegtm(a){a+=\"\\x3d\";for(var c=document.cookie.split(\";\"),d=0;d\u003Cc.length;d++){for(var b=c[d];\" \"==b.charAt(0);)b=b.substring(1);if(0==b.indexOf(a))return b.substring(a.length,b.length)}return\"\"}\nfunction setCookiegtm(a,c){document.cookie=a+\"\\x3d\"+c+\";path\\x3d\/;domain\\x3d.myperfectresume.com\"}function addCookieItem(a,c){var d=getCookiegtm(\"gtmvalues\"),b=[];null!=d\u0026\u0026void 0!=d\u0026\u0026\"\"!=d\u0026\u0026(b=JSON.parse(d));d={n:a,v:c};\"\"==getCookieItem(a)?b.push(d):$.map(b,function(b,d){b.n==a\u0026\u0026(b.v=c)});setCookiegtm(\"gtmvalues\",JSON.stringify(b))}function getCookieItem(a){var c=getCookiegtm(\"gtmvalues\"),d=[],b=\"\";null!=c\u0026\u0026void 0!=c\u0026\u0026\"\"!=c\u0026\u0026(d=JSON.parse(c),$.each(d,function(d,c){c.n===a\u0026\u0026(b=c.v)}));return b}\nvar mode=getParameterByName(\"mode\"),iorderid=getParameterByName(\"orderid\"),icust=getParameterByName(\"customerid\"),icustorder=icust+iorderid,yahoogp=getCookieItem(\"ygp\");mode=mode.toLowerCase();\"update\"!=mode\u0026\u0026\"alreadysubscribeduser\"!=mode\u0026\u0026$(document).ready(function(){\"\"!=yahoogp\u0026\u0026yahoogp==icustorder||!(0\u003C=icust||0\u003C=iorderid)||($(\"body\").append('\\x3cimg src\\x3d\"https:\/\/sp.analytics.yahoo.com\/spp.pl?a\\x3d10000\\x26.yp\\x3d421944\\x26ea\\x3dSubscription\" \/\\x3e'),addCookieItem(\"ygp\",icust+iorderid))});\u003C\/script\u003E\n\n",
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/javascript\"\u003Efunction getParameterByName(a){a=a.replace(\/[\\[]\/,\"\\\\[\").replace(\/[\\]]\/,\"\\\\]\");a=new RegExp(\"[\\\\?\\x26]\"+a+\"\\x3d([^\\x26#]*)\");a=a.exec(location.search);return null===a?\"\":decodeURIComponent(a[1].replace(\/\\+\/g,\" \"))}function getCookiegtm(a){a+=\"\\x3d\";for(var c=document.cookie.split(\";\"),b=0;b\u003Cc.length;b++){for(var d=c[b];\" \"==d.charAt(0);)d=d.substring(1);if(0==d.indexOf(a))return d.substring(a.length,d.length)}return\"\"}\nfunction setCookiegtm(a,c){document.cookie=a+\"\\x3d\"+c+\";path\\x3d\/;domain\\x3d.myperfectresume.com\"}function getCookieItem(a){var c=getCookiegtm(\"gtmvalues\"),b=[],d=\"\";null!=c\u0026\u0026void 0!=c\u0026\u0026\"\"!=c\u0026\u0026(b=JSON.parse(c),$.each(b,function(b,c){c.n===a\u0026\u0026(d=c.v)}));return d}function addCookieItem(a,c){var b=getCookiegtm(\"gtmvalues\"),d=[];null!=b\u0026\u0026void 0!=b\u0026\u0026\"\"!=b\u0026\u0026(d=JSON.parse(b));b={n:a,v:c};\"\"==getCookieItem(a)?d.push(b):$.map(d,function(b,d){b.n==a\u0026\u0026(b.v=c)});setCookiegtm(\"gtmvalues\",JSON.stringify(d))}\nvar mode=getParameterByName(\"mode\"),iorderid=getParameterByName(\"orderid\"),icust=getParameterByName(\"customerid\"),yahoogp1=getCookieItem(\"ygp1\"),icustord=icust+iorderid;mode=mode.toLowerCase();\"update\"!=mode\u0026\u0026\"alreadysubscribeduser\"!=mode\u0026\u0026$(document).ready(function(){yahoogp1==icustord\u0026\u0026\"\"!=yahoogp1||!(0\u003C=icust||0\u003C=iorderid)||($(\"body\").append('\\x3cimg src\\x3d\"https:\/\/sp.analytics.yahoo.com\/spp.pl?a\\x3d10000\\x26.yp\\x3d10026190\\x26ea\\x3dSubscription\" \/\\x3e'),addCookieItem(\"ygp1\",icust+iorderid))});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript defer data-gtmsrc=\"https:\/\/cdn.schemaapp.com\/javascript\/highlight.js\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":736
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",6],
      "arg1":"(www|dev4|jobs|templates|ebook).(livecareer|myperfectresume|jobtap|resume-now|cover-letter-now).(com|co\\.uk)",
      "ignore_case":true
    },{
      "function":"_eq",
      "arg0":["macro",5],
      ...
      "function":"_re",
      "arg0":["macro",7],
      "arg1":"(www|accounting|administration|agriculture|automotive|technology|construction|customer-service|education|finance|restaurant|government|healthcare|hospitality|it|repair|law-enforcement|legal|maintenance|management|marketing|entertainment|nursing|personal-care|industry|retail|sales|salon|social-services|transportation|production|wellness|ebook|jobtools|jobs|builder).(myperfectresume|myperfectresumeblog).com",
      "ignore_case":true
    },{
      "function":"_re",
      "arg0":["macro",6],
      "arg1":"\/billing\/(SubscriptionConfirmation|orderconfirmation|orderconfirmation-mobile).aspx",
      "ignore_case":true
    },{
      "function":"_cn",
      "arg0":["macro",6],
      ...
      "function":"_re",
      "arg0":["macro",7],
      "arg1":"(www|builder).myperfectresume.com",
      "ignore_case":true
    },{
      "function":"_re",
      "arg0":["macro",6],
      ...
      "function":"_re",
      "arg0":["macro",7],
      "arg1":"(jobs).myperfectresume.com",
      "ignore_case":true
    },{
      "function":"_re",
      "arg0":["macro",6],
      "arg1":"\/dashboard\/purchaseconfirmation",
      "ignore_case":true
    },{
      "function":"_re",
      "arg0":["macro",7],
      "arg1":"(www|builder|jobs).myperfectresume.com",
      "ignore_case":true
    },{
      "function":"_cn",
      "arg0":["macro",7],
      "arg1":"(regression|stg)-jobs.myperfectresume.com"
    },{
      "function":"_re",
      "arg0":["macro",6],
      "arg1":"\/(((int\\\/account)|account)\/resume-home.aspx|l)",
      "ignore_case":true
    },{
      "function":"_re",
      "arg0":["macro",7],
      "arg1":"(builder|www|jobs).myperfectresume.com"
    },{
      "function":"_re",
      "arg0":["macro",5],
      "arg1":"gtm.load",
  ...
  "rules":[
    ...
    [["if",5,6],["add",4]],
    [["if",4,7],["add",5,6,0]],
    [["if",4,8,10],["unless",9],["add",7,2,11,12]],
    [["if",4,11,12,13],["unless",9,10],["add",7,2,11,12]],
    [["if",4,12,14,15],["unless",9,16],["add",7,2,11,12]],
    [["if",4,12,17,18],["unless",9,16],["add",7,2,11,12]],
    [["if",4],["add",8,9]],
    [["if",19],["add",10]],
    [["if",7,20,21],["add",1,13]],
    [["if",7,22,23],["add",1]],
...
function Lc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.h[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Nc={},Oc=null,Pc=Math.random();Nc.m="GTM-NXP87FS";Nc.Db="c61";var Qc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Rc="www.googletagmanager.com/gtm.js";var Sc=Rc,Tc=null,Uc=null,Vc=null,Wc="//www.googletagmanager.com/a?id="+Nc.m+"&cv=67",Xc={},Yc={},Zc=function(){var a=Oc.sequence||0;Oc.sequence=a+1;return a};var $c={},I=function(a,b){$c[a]=$c[a]||[];$c[a][b]=!0},ad=function(a){for(var b=[],c=$c[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
if(""!==w){var y=function(N,L,S){for(var U=L.length-1;0<=U;U--){var na=L[U].split("=");if(na[0]===N)return na[1]||"1"}for(var ja=S.length-1;0<=ja;ja--){var ta=S[ja].split("=");if(ta[0]===N)return ta[1]||"1"}},x=Qe(Ji()),z=Pe(x,"query").split("&"),B=d.vtp_allowAnchor?Pe(x,"fragment").split("&"):[];q("gclid",y("gclid",B,z));q("gclsrc",y("gclsrc",B,z));q("dclid",y("dclid",B,z));e("_set","campaignParams",w)}d.vtp_enableInPageLinkId&&e("_require","inpage_linkid","//www.google-analytics.com/plugins/ga/inpage_linkid.js");g("_setCampaignTrack",
"vtp_campaignTrack");g("_setClientInfo","vtp_clientInfo");g("_setDetectFlash","vtp_detectFlash");g("_setDetectTitle","vtp_detectTitle");

e("_set","hitCallback",function(){qa(d.vtp_hitCallback)&&d.vtp_hitCallback();d.vtp_gtmOnSuccess()});if("TRACK_EVENT"==d.vtp_trackType){e("_trackEvent",String(d.vtp_eventCategory),String(d.vtp_eventAction),
